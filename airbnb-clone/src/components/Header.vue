<template>
    <div class="flex justify-end items-center bg-gray-200 p-1">
        <button class=" border-l border-r border-gray-400 mr-2">USA, Dollar(USD/$)</button>
        <button class="border-r border-gray-400 mr-2">English</button>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          </svg>
          
        <button class="border-r border-gray-400 mr-20">Login/Signup</button>
      </div>
