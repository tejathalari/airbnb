        ...
        <div class="flex flex-col items-center group">
          ...
          <div class="flex flex-col items-center group">
              ...
              <a href="/" class="text-sm font-medium ml-10 mr-0 mt-4 mb-4 relative group">
                ...
                <span class="mr-2 transition-opacity opacity-100 group-hover:opacity-75">Amazing</span>
            ...
            <div class="flex flex-col items-center group">
                ...
                <a href="/" class="text-sm font-medium ml-6 relative group">
                  ...
                  <span class="transition-opacity opacity-100 group-hover:opacity-75">Domes</span>
                  <span class="line"></span>
                </a>
            </div>
              <div class="flex flex-col items-center group">              
                  ...
                  <a href="/" class="text-sm font-medium ml-6 relative group">
                    ...
                    <span class="transition-opacity opacity-100 group-hover:opacity-75">OMG!</span>
                    <span class="line"></span>
                  </a>
              </div>
              ...
              <div class="flex flex-col items-center group">                                           
                <a href="/" class="text-sm font-medium ml-6 relative group">
                  ...
                  <span class="transition-opacity opacity-100 group-hover:opacity-75">Treehouses</span>
                  <span class="line"></span>
                </a>
              </div>
                  ...
                  <div class="flex flex-col items-center group">
                      ...
                      <a href="/" class="text-sm font-medium ml-6 relative group">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-4 transition-transform transform group-hover:scale-110">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z" />
                        </svg> 
                        <span class="transition-opacity opacity-100 group-hover:opacity-75">Mansions</span>
                        <span class="line"></span>
                      </a>
                  </div>
                    ...
                    <div class="flex flex-col items-center group">
                        ...
                        <a href="/" class="text-sm font-medium ml-6 relative group">
                          ...
                          <span class="transition-opacity opacity-100 group-hover:opacity-75">Trending</span>
                          <span class="line"></span>
                        </a>
                    </div>
                      ...
                      <div class="p-4 flex items-center ml-1 group">
                        <div class="flex flex-col items-center relative group">
                            ...
                            <a href="/" class="text-sm font-medium ml-6">
                              ...
                              <span class="transition-opacity opacity-100 group-hover:opacity-75">skiing</span>
                              <span class="line"></span>
                            </a>
                        </div>
                        ...
                        <div class="p-4 flex items-center ml-1 group">
                          <div class="flex flex-col items-center">                                                                                                                    
                              <a href="/" class="text-sm font-medium ml-6 relative group">
                                ...
                                <span class="transition-opacity opacity-100 group-hover:opacity-75">Countryside</span>
                                <span class="line"></span>
                              </a>
                          </div>
    ...
    Show Map
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-10">
        ...
        <p class="text-gray-600 font-semibold">$1,278 total before taxes</p>
          ...
          <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
            <a href="/">
              <img src="/photo21.jpeg" alt="Listing 1" class="mb-4 w-full h-48 object-cover rounded-md">
              <div class="absolute top-6 right-6">
                <!-- Love Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
          <a href="/">
          <img src="/photo22.jpeg" alt="Listing 2" class="mb-4 w-full h-48 object-cover rounded-md">
          <div class="absolute top-6 right-6">
            <!-- Love Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
          <a href="/">
          <img src="/photo23.jpeg" alt="Listing 3" class="mb-4 w-full h-48 object-cover rounded-md">
          <div class="absolute top-6 right-6">
            <!-- Love Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
          <a href="/">
          <img src="/photo24.jpeg" alt="Listing 4" class="mb-4 w-full h-48 object-cover rounded-md">
          <div class="absolute top-6 right-6">
            <!-- Love Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
          <a href="/">
          <img src="/photo25.jpeg" alt="Listing 5" class="mb-4 w-full h-48 object-cover rounded-md">
          <div class="absolute top-6 right-6">
            <!-- Love Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
          <a href="/">
          <img src="/photo26.jpeg" alt="Listing 6" class="mb-4 w-full h-48 object-cover rounded-md">
          <div class="absolute top-6 right-6">
            <!-- Love Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
          <a href="/">
            <img src="/photo27.jpeg" alt="Listing 4" class="mb-4 w-full h-48 object-cover rounded-md">
            <div class="absolute top-6 right-6">
              <!-- Love Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
          ...
          <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
            <a href="/">
            <img src="/photo28.jpeg" alt="Listing 5" class="mb-4 w-full h-48 object-cover rounded-md">
            <div class="absolute top-6 right-6">
              <!-- Love Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
          ...
          <div class="bg-white p-4 rounded-lg shadow-md transition transform hover:shadow-lg cursor-pointer">
            <a href="/">
            <img src="/photo29.jpeg" alt="Listing 6" class="mb-4 w-full h-48 object-cover rounded-md">
            <div class="absolute top-6 right-6">
              <!-- Love Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="gray" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21l-1.416-1.416C5.053 14.48 2 11.385 2 7.5 2 4.42 4.42 2 7.5 2c1.74 0 3.41.81 4.5 2.09C15.09 2.81 16.76 2 18.5 2 21.58 2 24 4.42 24 7.5c0 3.885-3.053 6.98-8.584 12.084L12 21z" />
...
.line {
  ...
  transform: scaleX(0); /* Initial state: hidden line */
